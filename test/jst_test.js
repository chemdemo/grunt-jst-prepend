...
exports['jst'] = {
  main: function(test) {
    ...
    expect = grunt.file.read("test/expected/prepend_vars.js");
    result = grunt.file.read("tmp/prepend_vars.js");
    test.equal(expect, result, "should has the variable `foo` and it's value is 1");
